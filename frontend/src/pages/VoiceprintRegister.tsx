  ...
  return (
    <div className="flex h-screen bg-zinc-950 items-center justify-center">
      <Card className="w-[420px] p-8 bg-zinc-900/80 border-zinc-800 text-center">
        <div className="mb-8">
          <h1 className="font-serif text-2xl tracking-wide text-amber-200/90 mb-2">声纹注册</h1>
          <p className="text-sm text-zinc-500">首次使用前，请朗读以下文本以注册您的声纹</p>
        </div>

        <Card className="p-6 mb-6 bg-zinc-950 border-zinc-800">
          <p className="text-lg text-zinc-300 leading-relaxed font-serif">"{registerText}"</p>
        </Card>
        ...
        {state === 'recording' && (
          <div className="space-y-4">
            <div className="flex items-center justify-center gap-2">
              ...
              <span className="text-red-400 font-mono">录音中... {countdown}s</span>
            </div>
